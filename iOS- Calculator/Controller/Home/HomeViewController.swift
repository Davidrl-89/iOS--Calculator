...
//  iOS- Calculator
//
//  Created by David Robles Lopez on 4/1/23.
//
...
final class HomeViewController: UIViewController {
    ...
    @IBOutlet weak var opertatorAC: UIButton!
    ...
    // MARK: - Button Actions
    @IBAction func opertatorACAction(_ sender: UIButton) {
    ...
    @IBAction func numberAction(_ sender: UIButton) {
        ...
        opertatorAC.setTitle("C", for: .normal)
    ...
    private func clear() {
        operation = .none
        opertatorAC.setTitle("AC", for: .normal)
        if temp != 0 {
            temp = 0
            resultLabel.text = "0"
        }else {
